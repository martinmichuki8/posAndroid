...
public class LineGraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        db = new DatabaseManager(LineGraph.this);
        ...
        set.data(db.getDateFromHistoryProducts());
    ...
    /*private List<DataEntry> setData(){
        List<DataEntry> seriesData = new ArrayList<>();
        seriesData.add(new CustomDataEntry("1986", 3, 20, 2));
